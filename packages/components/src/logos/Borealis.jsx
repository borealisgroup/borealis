...
const getViewBox = (shape, name, tagline) => {
  const defaultViewBox = '0 0 708.7 223.9';
  if (shape && tagline) return defaultViewBox;
  if (shape && name) return '0 0 708.7 120';
  if (shape) return '0 0 115 115';
  if (name && !tagline) return '175 53 535 67';
