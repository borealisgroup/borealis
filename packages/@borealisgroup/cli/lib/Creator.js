...
module.exports = class Creator extends EventEmitter {
  ...
  async create(cliOptions = {}, preset = null) {
    ...
    // so that bor-cli-service can setup git hooks.
  ...
  async resolvePreset(name, clone) {
    ...
    if (!preset) {
      ...
      if (presets.length) {
        ...
        log(`run bor-cli in manual mode to create a preset.`);
      }
      exit(1);
    }
    return preset;
