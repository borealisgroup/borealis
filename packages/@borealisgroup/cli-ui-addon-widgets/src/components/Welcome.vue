<template>
  <div class="welcome">
    <div class="logo-wrapper">
      <ItemLogo image="/public/vue-logo.png" class="logo vuejs" />
    </div>
    <div class="title">
      {{ $t('org.vue.widgets.welcome.content.title') }}
    </div>
    <div class="tips">
      <div v-for="n in 3" :key="n" :data-n="n" class="tip">
        <ItemLogo :image="tipIcons[n - 1]" class="icon" />
        <div class="message">
...
export default {
  ...
  created() {
    this.tipIcons = ['dashboard', 'arrow_back', 'home'];
  },
};
</script>
