<template>
  ...
  >
    <ApolloSubscribeToMore
      ...
      :updateQuery="
        (previousResult, { subscriptionData }) => {
          ...
          return {
            suggestions: [...previousResult.suggestions, newSuggestion],
          };
        }
      "
    />
    ...
    <ApolloSubscribeToMore
      ...
      :updateQuery="
        (previousResult, { subscriptionData }) => ({
          suggestions: previousResult.suggestions
            ? previousResult.suggestions.filter(
