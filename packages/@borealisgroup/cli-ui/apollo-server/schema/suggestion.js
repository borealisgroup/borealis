...
exports.resolvers = {
  ...
  Mutation: {
    suggestionActivate: (root, { input }, context) =>
      suggestions.activate(input, context),
  },

  Subscription: {
    suggestionAdded: {
      subscribe: (parent, args, { pubsub }) =>
        pubsub.asyncIterator(channels.SUGGESTION_ADDED),
    },
    suggestionUpdated: {
      subscribe: (parent, args, { pubsub }) =>
        pubsub.asyncIterator(channels.SUGGESTION_UPDATED),
    },
    suggestionRemoved: {
      subscribe: (parent, args, { pubsub }) =>
        pubsub.asyncIterator(channels.SUGGESTION_REMOVED),
    },
  },
};
